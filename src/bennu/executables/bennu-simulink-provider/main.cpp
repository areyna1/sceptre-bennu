...
{
public:
    // creating publishRate_setting class variable which is set to parameter value publishRate
    ...
    [[ noreturn ]] void periodicPublish()
    {
        while (1)
        {
            ...
            // changing sleep for when update of publishPoint made to duration specified by publishRate_setting
